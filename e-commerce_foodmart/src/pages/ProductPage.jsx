                                        ...
                                        {/* counter */}
                                            ...
                                            <div className="flex items-center gap-6 lg:gap-8 xl:gap-10">
                                                ...
                                                <button
                                                    ...
                                                    className={`flex cursor-pointer justify-center items-center bg-gray-200 ${(quantity === liveProduct.stock) ? `` : `hover:bg-gray-300`} w-8 lg:w-11 xl:w-14 2xl:h-11 font-extrabold rounded-md text-md`}
                                                ...
                                                <button
                                                    ...
                                                    className={`flex cursor-pointer justify-center items-center bg-gray-200 ${(quantity === 0) ? `` : `hover:bg-gray-300`} w-8 lg:w-11 xl:w-14 2xl:h-11 font-extrabold rounded-md text-md`}
