...
// ENVIRONMENT VARIABLES SETUP:  --------------------------------------------------------------------------------------------
    ...
    export const ORDERS_TABLE_ID = import.meta.env.VITE_APPWRITE_ORDERS_TABLE_ID;    // orders table
    
    export const ORDER_ITEMS_TABLE_ID = import.meta.env.VITE_APPWRITE_ORDER_ITEMS_TABLE_ID;    // order_items table
