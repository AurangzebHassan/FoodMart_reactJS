...
import { getMostViewedProducts } from "../../appwrite/db";
...
export default function MostViewedCarousel()
{
    ...
    // 🟢 Fetch new arrival products
        ...
        useEffect(() =>
        {
            ...
            async function loadProducts()
            {
                ...
                try
                {
                    const docs = await getMostViewedProducts();
                ...
                {
                    console.error("Failed to load most viewed products:", err);
            
            
                    if (mounted)
                    {
                        setError(err.message || "Failed to fetch most viewed products");
      ...
      return (
        ...
        <>
				...
				<div className="dark:hidden py-10 flex w-full gap-2 items-center justify-center">
					...
					<span className="text-yellow-500 md:text-2xl font-extrabold"> Loading Products Most Viewed </span>
				...
				<div className="py-10 hidden dark:flex w-full gap-2 items-center justify-center">
					...
					<span className="text-yellow-300 md:text-2xl font-extrabold"> Loading Products Most Viewed </span>
    ...
    if (error) console.warn("Most viewed products fetch error:", error);
  ...
  return (
    <section className="container mx-auto px-5 py-6 overflow-hidden">
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl md:text-3xl font-bold dark:text-white text-gray-800">Most Viewed</h2>

        {/* 🟩 RIGHT SIDE: 'View All' + arrows */}
        <div className="flex items-center gap-3">
          {/* <a
            href="/products/most-searched"
