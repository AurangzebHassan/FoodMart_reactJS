      ...
      return (
        ...
        <>
				...
				<div className="dark:hidden py-10 flex w-full gap-2 items-center justify-center">
					...
					<span className="text-yellow-500 md:text-2xl font-extrabold"> Loading New Arrivals </span>
				...
				<div className="py-10 hidden dark:flex w-full gap-2 items-center justify-center">
					...
					<span className="text-yellow-300 md:text-2xl font-extrabold"> Loading New Arrivals </span>
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`cursor-pointer text-xl md:text-3xl rounded-md w-10 h-7 md:w-12 md:md:h-9 flex items-center justify-center shadow-sm transition-all duration-200 
              ${
                isBeginning
