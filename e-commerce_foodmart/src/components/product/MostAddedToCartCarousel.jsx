      ...
      return (
        ...
        <>
				...
				<div className="dark:hidden py-10 flex w-full gap-2 items-center justify-center">
					...
					<span className="text-yellow-500 md:text-2xl font-extrabold"> Loading Products Most Added to Cart </span>
				...
				<div className="py-10 hidden dark:flex w-full gap-2 items-center justify-center">
					...
					<span className="text-yellow-300 md:text-2xl font-extrabold"> Loading Products Most Added to Cart </span>
  ...
  return (
    <section className="container mx-auto px-5 py-6 overflow-hidden">
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl md:text-3xl font-bold dark:text-white text-gray-800">Most Added To Cart</h2>
