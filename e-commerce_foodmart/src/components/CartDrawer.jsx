		...
		<div className="mt-3 border-t-3 pt-5">
			...
			<div className="grid grid-cols-3 gap-2">
				...
				<button
					...
					className="w-full bg-yellow-500 hover:bg-orange-600 active:bg-orange-600 hover:-translate-y-1 transition-all duration-200 col-span-2 text-white py-2 rounded-full mt-3 text-[18px] font-extrabold"
				...
				<button 
					...
					className="bg-red-500 hover:bg-red-600 active:bg-red-600 hover:-translate-y-1 transition-all duration-200 rounded-full mt-3 py-2 text-white font-extrabold"
				...
				>
					...
					{clearCartLoading ? "Processing..." : "Clear Cart"} 
